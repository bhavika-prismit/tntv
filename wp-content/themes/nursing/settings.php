...
<div class="wrap general-settings">
    ...
    <form class="form-group" name="generalSetting" id="generalSetting" method="post" action="#"
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        ...
                        <textarea type="text" name="address" cols="19"
                                  rows="3"><?php echo isset($content['address']) ? stripslashes(trim($content['address'])) : ""; ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="footer_logo"><?php echo wp_get_attachment_image($content['footer_logo']); ?></div>
                        </div>
                        <div class="col-sm-8 form-group">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            ...
                            <div class="header_logo"><?php echo wp_get_attachment_image($content['header_logo']); ?></div>
                        </div>
                        <div class="col-sm-8 form-group">
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-sm-4 form-group">
                            <label>Favicon</label>
                            <div class="favicon"><?php echo wp_get_attachment_image($content['favicon']); ?></div>
                        </div>
                        <div class="col-sm-8 form-group">
        ...
        <button type="submit" name="general_submit" id="general_submit">Submit</button>
    </form>
</div>